...
{
// UOA henchs
if(GetLocalInt(OBJECT_SELF,"Hench")>0){ExecuteScript("nw_ch_ac9",OBJECT_SELF);}else{
// UOA henchs
    ...
    */
    ...
    //* Create a small amount of treasure on the creature - ENABLED by Qlippoth
    ...
    SetListenPattern(OBJECT_SELF, "**", LISTEN_PATTERN);
