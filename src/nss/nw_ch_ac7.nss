...
int iSoldierNum = GetLocalInt(OBJECT_SELF,"SoldierNum");
...
else if(GetResRef(OBJECT_SELF)=="hench000")
 {
...
//SetLocalObject(OBJECT_SELF,"Hench",OBJECT_SELF);SetLocalInt(OBJECT_SELF,"HenchAction",2);ExecuteScript("henchs",OBJECT_SELF);
 }
// UOA
