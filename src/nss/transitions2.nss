...
// Dungeon
    ...
    {
if(GetStringLeft(sInterest,1)=="D"){if(GetPersistentString(oModule,sPlanet+"&"+sArea+IntToString(iSlot))==""){sDungeonType = GetPersistentString(oModule,sPlanet+"&"+sArea+"&Domain&"+IntToString(iSlot));sDungeonNumber = "1";sCheckDungeon = IntToString(iLevel2);}}
