...
while(GetIsObjectValid(oObjects))
    {
if(GetStringLeft(GetTag(oObjects),9)=="transport")
     {
if(GetStringLeft(GetResRef(oObjects),8)=="zep_ship"){EaseShipHullOut(oObjects);DestroyObject(oObjects,20.0);}
else{DestroyObject(oObjects);}
     }
