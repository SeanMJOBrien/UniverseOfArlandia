...
////////////////////////////////////////////////////////////////////////////////
// Hand the opener any gold this chest holds, rather than making them drag it
// out of the window. Runs on every open, not just the first: the stocking above
// is gated on "Config", so a chest opened again still pays out anything left in
// it. Items are untouched and looted normally. Corpses take the same sweep from
// loot_gold.nss - see _loot.nss.
LootGoldSweep(OBJECT_SELF,GetLastOpenedBy());
////////////////////////////////////////////////////////////////////////////////
}
