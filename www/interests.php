...
$planet = $_GET['planet'] ?? '';
$area = $_GET['area'] ?? '';
$interests_var = $planet."&".$area."&Interests";

// Fetch the primary 'Interests' data for the page
$stmt = mysqli_prepare($link, "SELECT val FROM pwdata WHERE name = ?");
mysqli_stmt_bind_param($stmt, "s", $interests_var);
mysqli_stmt_execute($stmt);
$query_result = mysqli_stmt_get_result($stmt);
$row = mysqli_fetch_assoc($query_result);
$interest = $row ? $row['val'] : '';
...
<table border="1" cellpadding="10" cellspacing="0" style="border-collapse: collapse" bordercolor="#404040" width="100%">
  <tr><td width="100%" valign="top"><font=Bell MT><font size=4><font bold=True><font color=#66CCFF>Planet : <font color=#FFC800><?php echo "$planet" ?><br/><br/><font=Bell MT><font size=4><font bold=True><font color=#66CCFF>Area : <font color=#FFC800><?php echo "$area" ?><br/></td></tr>
</table><br/><br/>
...
<table border="1" cellpadding="10" cellspacing="0" style="border-collapse: collapse" bordercolor="#404040" width="100%">
  <tr>
    <td width="100%" valign="top" colspan="2"><p><font=Bell MT><font size=4><font bold=True><font color=#66CCFF>Domain owner : </font><font color=#FFC800><?php echo $name;?></font><p/>
<?php
$var11pos = strpos($var,"_01_");$var1 = substr($var, 0, $var11pos); $var21pos = strpos($var,"_02_");$var21 = substr($var, 0, $var21pos);$var22pos = strpos($var21,"_01_");$var22 = strlen($var21);$var2 = substr($var21, $var22pos+4); $var31pos = strpos($var,"_03_");$var31 = substr($var, 0, $var31pos);$var32pos = strpos($var31,"_02_");$var32 = strlen($var31);$var3 = substr($var31, $var32pos+4); $var41pos = strpos($var,"_04_");$var41 = substr($var, 0, $var41pos);$var42pos = strpos($var41,"_03_");$var42 = strlen($var41);$var4 = substr($var41, $var42pos+4); $var51pos = strpos($var,"_05_");$var51 = substr($var, 0, $var51pos);$var52pos = strpos($var51,"_04_");$var52 = strlen($var51);$var5 = substr($var51, $var52pos+4); $var61pos = strpos($var,"_06_");$var61 = substr($var, 0, $var61pos);$var62pos = strpos($var61,"_05_");$var62 = strlen($var61);$var6 = substr($var61, $var62pos+4); $var71pos = strpos($var,"_07_");$var71 = substr($var, 0, $var71pos);$var72pos = strpos($var71,"_06_");$var72 = strlen($var71);$var7 = substr($var71, $var72pos+4); $var81pos = strpos($var,"_08_");$var81 = substr($var, 0, $var81pos);$var82pos = strpos($var81,"_07_");$var82 = strlen($var81);$var8 = substr($var81, $var82pos+4); $var91pos = strpos($var,"_09_");$var91 = substr($var, 0, $var91pos);$var92pos = strpos($var91,"_08_");$var92 = strlen($var91);$var9 = substr($var91, $var92pos+4); $var101pos = strpos($var,"_10_");$var101 = substr($var, 0, $var101pos);$var102pos = strpos($var101,"_09_");$var102 = strlen($var101);$var10 = substr($var101, $var102pos+4); $var111pos = strpos($var,"_11_");$var111 = substr($var, 0, $var111pos);$var112pos = strpos($var111,"_10_");$var112 = strlen($var111);$var11 = substr($var111, $var112pos+4);
$var1 = substr($var1, 0, strpos($var1,"%")); $var2 = substr($var2, 0, strpos($var2,"%")); $var3 = substr($var3, 0, strpos($var3,"%")); $var4 = substr($var4, 0, strpos($var4,"%")); $var5 = substr($var5, 0, strpos($var5,"%")); $var6 = substr($var6, 0, strpos($var6,"%")); $var7 = substr($var7, 0, strpos($var7,"%")); $var8b = substr($var8, -1); $var8 = substr($var8, 0, strpos($var8,"%")); $var9 = substr($var9, 0, strpos($var9,"%")); $var10 = substr($var10, 0, strpos($var10,"%"));
$var = "";$structure = "";$i = 0;$i1 = 0;$i2 = 0;$i3 = 0;
while($i<10){$i++; if($i==1){$structure = $var1;}else if($i==2){$structure = $var2;}else if($i==3){$structure = $var3;}else if($i==4){$structure = $var4;}else if($i==5){$structure = $var5;}else if($i==6){$structure = $var6;}else if($i==7){$structure = $var7;}else if($i==8){$structure = $var8;}else if($i==9){$structure = $var9;}else if($i==10){$structure = $var10;} if(($structure==5)||($structure==7)||($structure==8)||($structure==21)){$i1++;} else if($structure==6){$i2++;} else if($structure!=0){$i3++;}}
if($i1>0){$var = "Primary";} if($i2>0){if($var==""){$var = "Secundary";}else{$var = $var.", Secundary";}} if($i3>0){if($var==""){$var = "Tertiary";}else{$var = $var.", Tertiary";}}
?><font=Bell MT><font size=4><font bold=True><font color=#66CCFF>Domain sectors : </font><font color=#FFC800><?php echo $var;?></font></td>
  </tr>
  <tr><td width="30%" valign="top"><p><font=Bell MT><font size=4><font bold=True><font color=#66CCFF>Domain description : </font><p/></td><td width="70%" valign="top"><p><font=Bell MT><font size=4><font bold=True><font color=#00FF00><?php echo $var11;?></font><p/></td></tr>
</table><br/><br/>
<?php
if($var8b>2) { ?>
<table border="1" cellpadding="10" cellspacing="0" style="border-collapse: collapse" bordercolor="#404040" width="100%">
...
<?php
$mail_var = $planet."&".$area."&Mailbox";
$stmt = mysqli_prepare($link, "SELECT val FROM pwdata WHERE name = ?");
mysqli_stmt_bind_param($stmt, "s", $mail_var);
mysqli_stmt_execute($stmt);
$result = mysqli_fetch_assoc(mysqli_stmt_get_result($stmt));
$result = $result ? $result['val'] : '';
if(($result=="")||($result=="0")){ ?> <font=Bell MT><font size=4><font bold=True><font color=#66CCFF>Mailbox : <font color=#FFC800>empty</font> <?php } else { ?> <font=Bell MT><font size=4><font bold=True><font color=#66CCFF>Mailbox : <font color=#00FF00>mail</font> <?php }
?></td></tr></table>
<?php } }
else if($inttype=="1") { // Cities and Towns
?>
<table border="1" cellpadding="10" cellspacing="0" style="border-collapse: collapse" bordercolor="#404040" width="100%">
  <tr><td width="100%" valign="top" colspan="2">
...
<font=Bell MT><font size=4><font bold=True><font color=#66CCFF>Special shop :<font color=#FFC800> <?php echo "$var" ?></td></tr>
  <tr><td width="30%" valign="top"><p><font=Bell MT><font size=4><font bold=True><font color=#66CCFF>Local player shop :</font><p/></td><td width="70%" valign="top">
<?php
// PERFORMANCE: Fetch all shop items in one query instead of one query per shop.
$shop_items = [];
$like_pattern = $planet."&".$area."&SaleShop%";
$stmt = mysqli_prepare($link, "SELECT val FROM pwdata WHERE name LIKE ?");
mysqli_stmt_bind_param($stmt, "s", $like_pattern);
mysqli_stmt_execute($stmt);
$query_result = mysqli_stmt_get_result($stmt);
while($row = mysqli_fetch_assoc($query_result)) {
    $result = str_replace("~","'" , $row['val']);
    ...
    while($iT<$Var) {
        ...
        $shop_items[] = $Name."_A_".$Master."_B_".$Value."_C_".$WearP."_D_";
    }
}
@ sort($shop_items);
foreach($shop_items as $Vars) {
    $Name1pos = strpos($Vars,"_A_");$Name = substr($Vars, 0, $Name1pos); $Master1pos = strpos($Vars,"_B_");$Master1 = substr($Vars, 0, $Master1pos);$Master2pos = strpos($Master1,"_A_");$Master2 = strlen($Master1);$Master = substr($Master1, $Master2pos+3); $Value1pos = strpos($Vars,"_C_");$Value1 = substr($Vars, 0, $Value1pos);$Value2pos = strpos($Value1,"_B_");$Value2 = strlen($Value1);$Value = substr($Value1, $Value2pos+3); $WearP1pos = strpos($Vars,"_D_");$WearP1 = substr($Vars, 0, $WearP1pos);$WearP2pos = strpos($WearP1,"_C_");$WearP2 = strlen($WearP1);$WearP = substr($WearP1, $WearP2pos+3);
...
?></td></tr></table><br/><br/>
<table border="1" cellpadding="10" cellspacing="0" style="border-collapse: collapse" bordercolor="#404040" width="100%">
  <tr><td width="30%" valign="top"><p><font=Bell MT><font size=4><font bold=True><font color=#66CCFF>Local message board :</font><p/></td><td width="70%" valign="top">
<?php
// PERFORMANCE: Fetch all board messages in one query per board.
$board_messages = [];
$like_pattern = $planet."&DHBoard%";
$stmt = mysqli_prepare($link, "SELECT val FROM pwdata WHERE name LIKE ? ORDER BY name DESC");
mysqli_stmt_bind_param($stmt, "s", $like_pattern);
mysqli_stmt_execute($stmt);
$query_result = mysqli_stmt_get_result($stmt);
while($row = mysqli_fetch_assoc($query_result)) {
    $All = str_replace("~","'" , $row['val']);
    $author1pos = strpos($All,"_A_");$author = substr($All, 0, $author1pos); $title1pos = strpos($All,"_B_");$title1 = substr($All, 0, $title1pos);$title2pos = strpos($title1,"_A_");$title2 = strlen($title1);$title = substr($title1, $title2pos+3); $message = substr($All, strpos($All,"_B_")+3);
...
$like_pattern = $planet."&".$area."&Board%";
$stmt = mysqli_prepare($link, "SELECT val FROM pwdata WHERE name LIKE ? ORDER BY name DESC");
mysqli_stmt_bind_param($stmt, "s", $like_pattern);
mysqli_stmt_execute($stmt);
$query_result = mysqli_stmt_get_result($stmt);
...
// PERFORMANCE: Fetch all dungeon data at once.
$like_pattern = 'Dungeons%';
$stmt = mysqli_prepare($link, "SELECT val FROM pwdata WHERE name LIKE ?");
mysqli_stmt_bind_param($stmt, "s", $like_pattern);
mysqli_stmt_execute($stmt);
$query_result = mysqli_stmt_get_result($stmt);
while($row = mysqli_fetch_assoc($query_result)) {
    $dungeonfullAct = $row['val'];
...
?><font=Bell MT><font size=4><font bold=True><font color=#66CCFF>Dungeon type :<font color=#FFC800> <?php echo "$dungeontype" ?><br><br><font=Bell MT><font size=4><font bold=True><font color=#66CCFF>Dungeon monster family :<font color=#FFC800> <?php echo "$dungeonfamily" ?><br>
<?php 
...
else if($inttype=="5") { // Animal reserves
?>
<table border="1" cellpadding="10" cellspacing="0" style="border-collapse: collapse" bordercolor="#404040" width="100%">
  <tr><td width="100%" valign="top" colspan="2">
<?php
...
$reserve11pos = strpos($interest,"_C_");$reserve11 = substr($interest, 0, $reserve11pos);$reserve12pos = strpos($reserve11,"_B_");$dungeontype12 = strlen($reserve11);$reserve1 = substr($reserve11, $reserve12pos+3);$reserve1L = substr($reserve1,0,1); $reserve21pos = strpos($interest,"_D_");$reserve21 = substr($interest, 0, $reserve21pos);$reserve22pos = strpos($reserve21,"_C_");$dungeontype22 = strlen($reserve21);$reserve2 = substr($reserve21, $reserve22pos+3);$reserve2L = substr($reserve2,0,1); $reserve31pos = strpos($interest,"_E_");$reserve31 = substr($interest, 0, $reserve31pos);$reserve32pos = strpos($reserve31,"_D_");$dungeontype32 = strlen($reserve31);$reserve3 = substr($reserve31, $reserve32pos+3);$reserve3L = substr($reserve3,0,1); $reserve41pos = strpos($interest,"_F_");$reserve41 = substr($interest, 0, $reserve41pos);$reserve42pos = strpos($reserve41,"_E_");$dungeontype42 = strlen($reserve41);$reserve4 = substr($reserve41, $reserve42pos+3);$reserve4L = substr($reserve4,0,1); $reserve51pos = strpos($interest,"_G_");$reserve51 = substr($interest, 0, $reserve51pos);$reserve52pos = strpos($reserve51,"_F_");$dungeontype52 = strlen($reserve51);$reserve5 = substr($reserve51, $reserve52pos+3);$reserve5L = substr($reserve5,0,1);
$i1 = 0;$reserveL = "";
while($i1<5) {
    ...
    else if($reserveL==1){$reserveL = "Deers";} else if($reserveL==2){$reserveL = "Wild Angus";} else if($reserveL==3){$reserveL = "Badgers";} else if($reserveL==4){$reserveL = "Bears";} else if($reserveL==5){$reserveL = "Boars";} else if($reserveL==6){$reserveL = "Goats";}
    if($reserveL=="None") { ?> <font=Bell MT><font size=4><font bold=True><font color=#66CCFF>Pen <?php echo $i1; ?> :<font color=#FF0000> <?php echo $reserveL; ?><br> <?php } else { ?> <font=Bell MT><font size=4><font bold=True><font color=#66CCFF>Pen <?php echo $i1; ?> :<font color=#FFC800> <?php echo $reserveL; ?><br> <?php }
}
?></td></tr></table>
<?php
}
